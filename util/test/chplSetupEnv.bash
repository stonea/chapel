...
_chplSetupEnv_pathsToRun=("/data/cf/chapel/chplSetup/" "/chapel/data/chaptools/chplSetup" "/cray/css/users/chapelu/chplSetup" "$CHPL_HOME/chplSetup" "$HOME/.chplSetup" "$(pwd)/chplSetup")
