...
// Creates a new bytes literal with the given value. If size is -1 we'll
// use strlen internally to determine the length of s. Pass in the size manually
// if s could contain any \0 values.
VarSymbol *new_BytesSymbol(const char *s, long size=-1);
